/* CSE 2312 - Summer 2021 - Lab 3 Driver
 *
...
int main(void) {
	...
	printf("Question 1, sumF32: Correct answer = 6.6\n");
	printf("Question 1, sumF32: Student answer = %.1f\n\n", sumF32(fArray, COUNT));
	
	printf("Question 2, prodF64: Correct answer = 7.161\n");
	printf("Question 2, prodF64: Student answer = %.3lf\n\n", prodF64(dArray, COUNT));
	
	printf("Question 3, dotpF64: Correct answer = 26.83\n");
	printf("Question 3, dotpF64: Student answer = %.2lf\n\n", dotpF64(dArray, dArray_y, COUNT));
	
	printf("Question 4, maxF32: Correct answer = 3.2\n");
	printf("Question 4, maxF32: Student answer = %.1f\n\n", maxF32(fArray, COUNT));
	...
	printf("Question 6, sqrtSumF64: Correct answer = 2.510\n");
